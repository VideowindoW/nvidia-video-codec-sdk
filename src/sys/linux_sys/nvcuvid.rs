...
pub struct Cuvid {
    ...
    pub cuvidCreateVideoSource: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuvidCreateVideoSourceW: Result<
        unsafe extern "C" fn(
            pObj: *mut CUvideosource,
        ...
        ::libloading::Error,
    >,
    pub cuvidDestroyVideoSource:
        Result<unsafe extern "C" fn(obj: CUvideosource) -> CUresult, ::libloading::Error>,
    pub cuvidSetVideoSourceState: Result<
        unsafe extern "C" fn(obj: CUvideosource, state: cudaVideoState) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidGetVideoSourceState:
        Result<unsafe extern "C" fn(obj: CUvideosource) -> cudaVideoState, ::libloading::Error>,
    pub cuvidGetSourceVideoFormat: Result<
        unsafe extern "C" fn(
            obj: CUvideosource,
        ...
        ::libloading::Error,
    >,
    pub cuvidGetSourceAudioFormat: Result<
        unsafe extern "C" fn(
            obj: CUvideosource,
        ...
        ::libloading::Error,
    >,
    pub cuvidCreateVideoParser: Result<
        unsafe extern "C" fn(pObj: *mut CUvideoparser, pParams: *mut CUVIDPARSERPARAMS) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidParseVideoData: Result<
        unsafe extern "C" fn(obj: CUvideoparser, pPacket: *mut CUVIDSOURCEDATAPACKET) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidDestroyVideoParser:
        Result<unsafe extern "C" fn(obj: CUvideoparser) -> CUresult, ::libloading::Error>,
}
...
impl Cuvid {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let cuvidCreateVideoSource = __library.get(b"cuvidCreateVideoSource ").map(|sym| *sym);
        let cuvidCreateVideoSourceW = __library.get(b"cuvidCreateVideoSourceW ").map(|sym| *sym);
        let cuvidDestroyVideoSource = __library.get(b"cuvidDestroyVideoSource ").map(|sym| *sym);
        let cuvidSetVideoSourceState = __library.get(b"cuvidSetVideoSourceState ").map(|sym| *sym);
        let cuvidGetVideoSourceState = __library.get(b"cuvidGetVideoSourceState ").map(|sym| *sym);
        let cuvidGetSourceVideoFormat = __library
            .get(b"cuvidGetSourceVideoFormat ")
            .map(|sym| *sym);
        let cuvidGetSourceAudioFormat = __library
            .get(b"cuvidGetSourceAudioFormat ")
            .map(|sym| *sym);
        let cuvidCreateVideoParser = __library.get(b"cuvidCreateVideoParser ").map(|sym| *sym);
        let cuvidParseVideoData = __library.get(b"cuvidParseVideoData ").map(|sym| *sym);
        let cuvidDestroyVideoParser = __library.get(b"cuvidDestroyVideoParser ").map(|sym| *sym);
        Ok(Cuvid {
            __library,
    ...
    #[must_use]
    pub unsafe fn cuvidCreateVideoSource(
        &self,
        pObj: *mut CUvideosource,
        pszFileName: *const ::core::ffi::c_char,
        pParams: *mut CUVIDSOURCEPARAMS,
        ...
        (self
            .cuvidCreateVideoSource
            .as_ref()
            .expect("Expected function, got error."))(pObj, pszFileName, pParams)
    }
    #[must_use]
    pub unsafe fn cuvidCreateVideoSourceW(
        &self,
        pObj: *mut CUvideosource,
        pwszFileName: *const wchar_t,
        pParams: *mut CUVIDSOURCEPARAMS,
        ...
        (self
            .cuvidCreateVideoSourceW
            .as_ref()
            .expect("Expected function, got error."))(pObj, pwszFileName, pParams)
    }
    #[must_use]
    pub unsafe fn cuvidDestroyVideoSource(&self, obj: CUvideosource) -> CUresult {
        (self
            .cuvidDestroyVideoSource
            .as_ref()
    ...
    #[must_use]
    pub unsafe fn cuvidSetVideoSourceState(
        &self,
        obj: CUvideosource,
        ...
        (self
            .cuvidSetVideoSourceState
            .as_ref()
            .expect("Expected function, got error."))(obj, state)
    }
    pub unsafe fn cuvidGetVideoSourceState(&self, obj: CUvideosource) -> cudaVideoState {
        (self
            .cuvidGetVideoSourceState
            .as_ref()
            .expect("Expected function, got error."))(obj)
    ...
    #[must_use]
    pub unsafe fn cuvidGetSourceVideoFormat(
        &self,
        obj: CUvideosource,
        pvidfmt: *mut CUVIDEOFORMAT,
        flags: ::core::ffi::c_uint,
        ...
        (self
            .cuvidGetSourceVideoFormat
            .as_ref()
            .expect("Expected function, got error."))(obj, pvidfmt, flags)
    }
    #[must_use]
    pub unsafe fn cuvidGetSourceAudioFormat(
        &self,
        obj: CUvideosource,
        paudfmt: *mut CUAUDIOFORMAT,
        flags: ::core::ffi::c_uint,
        ...
        (self
            .cuvidGetSourceAudioFormat
            .as_ref()
            .expect("Expected function, got error."))(obj, paudfmt, flags)
    }
    #[must_use]
    pub unsafe fn cuvidCreateVideoParser(
        ...
        (self
            .cuvidCreateVideoParser
            .as_ref()
            .expect("Expected function, got error."))(pObj, pParams)
    }
    #[must_use]
    pub unsafe fn cuvidParseVideoData(
        &self,
        obj: CUvideoparser,
        ...
        (self
            .cuvidParseVideoData
            .as_ref()
            .expect("Expected function, got error."))(obj, pPacket)
    }
    #[must_use]
    pub unsafe fn cuvidDestroyVideoParser(&self, obj: CUvideoparser) -> CUresult {
        (self
            .cuvidDestroyVideoParser
            .as_ref()
            .expect("Expected function, got error."))(obj)
