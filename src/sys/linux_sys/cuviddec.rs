...
pub struct Cuviddec {
    ...
    pub cuvidGetDecoderCaps:
        Result<unsafe extern "C" fn(pdc: *mut CUVIDDECODECAPS) -> CUresult, ::libloading::Error>,
    pub cuvidCreateDecoder: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuvidDestroyDecoder:
        Result<unsafe extern "C" fn(hDecoder: CUvideodecoder) -> CUresult, ::libloading::Error>,
    pub cuvidDecodePicture: Result<
        unsafe extern "C" fn(hDecoder: CUvideodecoder, pPicParams: *mut CUVIDPICPARAMS) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidGetDecodeStatus: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuvidReconfigureDecoder: Result<
        unsafe extern "C" fn(
            hDecoder: CUvideodecoder,
        ...
        ::libloading::Error,
    >,
    pub cuvidMapVideoFrame64: Result<
        unsafe extern "C" fn(
            hDecoder: CUvideodecoder,
            nPicIdx: ::core::ffi::c_int,
        ...
        ::libloading::Error,
    >,
    pub cuvidUnmapVideoFrame64: Result<
        unsafe extern "C" fn(
            hDecoder: CUvideodecoder,
        ...
        ::libloading::Error,
    >,
    pub cuvidCtxLockCreate: Result<
        unsafe extern "C" fn(pLock: *mut CUvideoctxlock, ctx: CUcontext) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidCtxLockDestroy:
        Result<unsafe extern "C" fn(lck: CUvideoctxlock) -> CUresult, ::libloading::Error>,
    pub cuvidCtxLock: Result<
        unsafe extern "C" fn(lck: CUvideoctxlock, reserved_flags: ::core::ffi::c_uint) -> CUresult,
        ::libloading::Error,
    >,
    pub cuvidCtxUnlock: Result<
        unsafe extern "C" fn(lck: CUvideoctxlock, reserved_flags: ::core::ffi::c_uint) -> CUresult,
        ::libloading::Error,
    >,
}
...
impl Cuviddec {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let cuvidGetDecoderCaps = __library.get(b"cuvidGetDecoderCaps ").map(|sym| *sym);
        let cuvidCreateDecoder = __library.get(b"cuvidCreateDecoder ").map(|sym| *sym);
        let cuvidDestroyDecoder = __library.get(b"cuvidDestroyDecoder ").map(|sym| *sym);
        let cuvidDecodePicture = __library.get(b"cuvidDecodePicture ").map(|sym| *sym);
        let cuvidGetDecodeStatus = __library.get(b"cuvidGetDecodeStatus ").map(|sym| *sym);
        let cuvidReconfigureDecoder = __library.get(b"cuvidReconfigureDecoder ").map(|sym| *sym);
        let cuvidMapVideoFrame64 = __library.get(b"cuvidMapVideoFrame64 ").map(|sym| *sym);
        let cuvidUnmapVideoFrame64 = __library.get(b"cuvidUnmapVideoFrame64 ").map(|sym| *sym);
        let cuvidCtxLockCreate = __library.get(b"cuvidCtxLockCreate ").map(|sym| *sym);
        let cuvidCtxLockDestroy = __library.get(b"cuvidCtxLockDestroy ").map(|sym| *sym);
        let cuvidCtxLock = __library.get(b"cuvidCtxLock ").map(|sym| *sym);
        let cuvidCtxUnlock = __library.get(b"cuvidCtxUnlock ").map(|sym| *sym);
        Ok(Cuviddec {
            __library,
            cuvidGetDecoderCaps,
            cuvidCreateDecoder,
    ...
    #[must_use]
    pub unsafe fn cuvidGetDecoderCaps(&self, pdc: *mut CUVIDDECODECAPS) -> CUresult {
        (self
            .cuvidGetDecoderCaps
            .as_ref()
            .expect("Expected function, got error."))(pdc)
    }
    #[must_use]
    pub unsafe fn cuvidCreateDecoder(
        ...
        (self
            .cuvidCreateDecoder
            .as_ref()
            .expect("Expected function, got error."))(phDecoder, pdci)
    }
    #[must_use]
    pub unsafe fn cuvidDestroyDecoder(&self, hDecoder: CUvideodecoder) -> CUresult {
        (self
            .cuvidDestroyDecoder
            .as_ref()
            .expect("Expected function, got error."))(hDecoder)
    }
    #[must_use]
    pub unsafe fn cuvidDecodePicture(
        ...
        (self
            .cuvidDecodePicture
            .as_ref()
            .expect("Expected function, got error."))(hDecoder, pPicParams)
    }
    #[must_use]
    pub unsafe fn cuvidGetDecodeStatus(
        &self,
        hDecoder: CUvideodecoder,
        nPicIdx: ::core::ffi::c_int,
        pDecodeStatus: *mut CUVIDGETDECODESTATUS,
        ...
        (self
            .cuvidGetDecodeStatus
            .as_ref()
            .expect("Expected function, got error."))(hDecoder, nPicIdx, pDecodeStatus)
    }
    #[must_use]
    pub unsafe fn cuvidReconfigureDecoder(
        &self,
        hDecoder: CUvideodecoder,
        pDecReconfigParams: *mut CUVIDRECONFIGUREDECODERINFO,
    ) -> CUresult {
        (self
            .cuvidReconfigureDecoder
            .as_ref()
            .expect("Expected function, got error."))(hDecoder, pDecReconfigParams)
    }
    #[must_use]
    pub unsafe fn cuvidMapVideoFrame64(
        &self,
        hDecoder: CUvideodecoder,
        nPicIdx: ::core::ffi::c_int,
        pDevPtr: *mut ::core::ffi::c_ulonglong,
    ...
    #[must_use]
    pub unsafe fn cuvidUnmapVideoFrame64(
        &self,
        hDecoder: CUvideodecoder,
        DevPtr: ::core::ffi::c_ulonglong,
    ) -> CUresult {
        (self
            .cuvidUnmapVideoFrame64
            .as_ref()
            .expect("Expected function, got error."))(hDecoder, DevPtr)
    }
    #[must_use]
    pub unsafe fn cuvidCtxLockCreate(
        &self,
        pLock: *mut CUvideoctxlock,
        ctx: CUcontext,
    ) -> CUresult {
        (self
            .cuvidCtxLockCreate
            .as_ref()
            .expect("Expected function, got error."))(pLock, ctx)
    }
    #[must_use]
    pub unsafe fn cuvidCtxLockDestroy(&self, lck: CUvideoctxlock) -> CUresult {
        (self
            .cuvidCtxLockDestroy
            .as_ref()
            .expect("Expected function, got error."))(lck)
    }
    #[must_use]
    pub unsafe fn cuvidCtxLock(
        &self,
        lck: CUvideoctxlock,
        reserved_flags: ::core::ffi::c_uint,
    ) -> CUresult {
        (self
            .cuvidCtxLock
            .as_ref()
            .expect("Expected function, got error."))(lck, reserved_flags)
    }
    #[must_use]
    pub unsafe fn cuvidCtxUnlock(
        &self,
        lck: CUvideoctxlock,
        reserved_flags: ::core::ffi::c_uint,
    ) -> CUresult {
